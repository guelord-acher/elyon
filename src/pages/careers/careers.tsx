...
const OPENINGS = [
  {
    ...
    type: "CDI",
    desc: "Concevez et construisez les systèmes distribués qui traitent des millions de documents chaque jour.",
  },
  {
    ...
    location: "Paris / Remote",
    type: "CDI",
    desc: "Créez une expérience développeur exceptionnelle pour notre dashboard et notre documentation interactive.",
  },
  {
    ...
    location: "Remote",
    type: "CDI",
    desc: "Animez notre communauté technique, créez du contenu et faites connaître Elyon aux développeurs.",
  },
  {
    ...
    location: "Paris",
    type: "CDI",
    desc: "Concevez des interfaces intuitives pour des outils techniques complexes destinés aux développeurs.",
  },
]

const PERKS = [
  { icon: Heart, text: "Mutuelle prise en charge à 100%" },
  { icon: Users, text: "Budget formation et conférences" },
  { icon: Zap, text: "Matériel de pointe au choix" },
  { icon: Home, text: "Remote-friendly, bureau à Paris" },
  { icon: Coffee, text: "Tickets restaurant et snacks" },
  { icon: Briefcase, text: "BSPCE et intéressement" },
]
    ...
    <div className="min-h-svh pt-24">
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <h1 className="mt-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl max-w-3xl">Carrières</h1>
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            ...
            Nous recrutons des talents passionnés et bienveillants.
          </p>
          <div className="mt-10">
