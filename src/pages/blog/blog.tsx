...
const POSTS = [
  {
    title: "Comment nous avons réduit le temps de rendu de 60%",
    desc: "Les optimisations qui ont transformé notre moteur de rendu : caching intelligent, rendu distribué et compilation JIT.",
    date: "15 Mai 2026",
    readTime: "8 min",
    tag: "Technique",
  },
  {
    ...
    desc: "Retour sur notre choix technologique : performances, sécurité mémoire et écosystème. Les leçons apprises après 2 ans de production.",
    date: "28 Avril 2026",
    readTime: "12 min",
    tag: "Technique",
  },
  {
    ...
    desc: "Comment intégrer des tests de rendu et de l'impression automatisée dans vos pipelines GitHub Actions et GitLab CI.",
    date: "10 Avril 2026",
    readTime: "6 min",
    tag: "Guide",
  },
  {
    ...
    desc: "Découvrez ce qui vous attend : nouveau SDK, API v2, file d'attente prioritaire, et bien plus.",
    date: "1 Avril 2026",
    readTime: "5 min",
    tag: "Produit",
  },
  {
    ...
    desc: "Les coulisses de notre infrastructure : déploiement multi-régions, failover automatique et monitoring en temps réel.",
    date: "15 Mars 2026",
    readTime: "10 min",
    tag: "Infra",
  },
  {
    title: "Intégrer l'impression avec Python en 5 minutes",
    desc: "Un tutoriel pas à pas pour installer le SDK Python, configurer votre première file d'attente et imprimer votre premier document.",
    date: "1 Mars 2026",
    readTime: "4 min",
    tag: "Tutoriel",
  },
