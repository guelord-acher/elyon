...
const LANGUAGES = [
  ...
  { name: "PHP", status: "En dÃ©veloppement", color: "text-purple-500" },
  { name: "Ruby", status: "En dÃ©veloppement", color: "text-red-600" },
  { name: ".NET", status: "PlanifiÃ©", color: "text-violet-500" },
  { name: "Swift", status: "PlanifiÃ©", color: "text-orange-500" },
]
const TOOLS = [
  {
    icon: BookOpen,
    title: "Guides de dÃ©marrage",
    desc: "Des guides pas Ã  pas pour chaque langage, de l'installation Ã  votre premiÃ¨re impression en 5 minutes.",
  },
  {
    icon: GitFork,
    title: "Exemples open-source",
    desc: "Des projets d'exemple complets sur GitHub. Forkez, clonez et lancez-vous sans tout construire depuis zÃ©ro.",
  },
  {
    icon: Terminal,
    title: "CLI companion",
    desc: "Notre CLI s'installe en une commande et s'intÃ¨gre nativement avec tous nos SDK pour le dÃ©bogage et les tests.",
  },
  {
    icon: Wrench,
    title: "Types et typages",
    desc: "Des dÃ©finitions de types complÃ¨tes pour TypeScript, Python (Pyright/mypy) et Go. DÃ©tection d'erreurs Ã  la compilation.",
  },
  {
    icon: Code2,
    title: "Exemples prÃªts Ã  l'emploi",
    desc: "Des snippets pour les cas d'usage courants : impression facture, envoi batch, gÃ©nÃ©ration rapports, et plus encore.",
  },
  {
    icon: ExternalLink,
    title: "IntÃ©grations tierces",
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            ...
            expÃ©rience de dÃ©veloppement cohÃ©rente et idiomatique, quel que
            soit votre Ã©cosystÃ¨me.
          </p>
          <div className="mt-10">
          ...
          <h2 className="text-xl font-semibold sm:text-2xl">Langages supportÃ©s</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            SDK officiels maintenus par notre Ã©quipe. Chaque SDK suit les conventions du langage.
          </p>
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-primary/[0.06] via-background/50 to-background/50 p-8 sm:p-12">
            ...
            <p className="mt-3 max-w-xl text-base leading-relaxed text-muted-foreground">
              ...
              Consultez notre documentation ou contribuez Ã  nos SDK open-source.
            </p>
