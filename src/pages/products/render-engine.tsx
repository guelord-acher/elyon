...
const CAPABILITIES = [
  "Rendu HTML vers PDF haute fidélité",
  ...
  "Support des encres et profils colorimétriques",
  "Génération de PDF/A pour l'archivage légal",
]
...
const FEATURES = [
  {
    icon: FileText,
    title: "HTML vers PDF",
    desc: "Transformez n'importe quel template HTML en PDF prêt à imprimer. Support de CSS moderne, Flexbox, Grid et variables CSS.",
  },
  {
    icon: Palette,
    title: "Paged Media",
    desc: "Contrôle précis des sauts de page, en-têtes, pieds de page, marges et numérotation. Idéal pour les documents multi-pages.",
  },
  {
    icon: Gauge,
    title: "Rendu asynchrone",
    desc: "Soumettez des documents volumineux sans attendre. Recevez une notification dès que le rendu est terminé, prêt à télécharger.",
  },
  {
    icon: Lock,
    title: "Sécurité des documents",
    desc: "Chiffrement de bout en bout, protection par mot de passe, permissions d'impression et certificats numériques.",
  },
  {
    icon: Crop,
    title: "Optimisation automatique",
    desc: "Compression intelligente des images, subsetting des polices et déduction des pages blanches. Des fichiers jusqu'à 80% plus légers.",
  },
  {
    icon: Zap,
    title: "Rendu distribué",
    desc: "Notre moteur répartit automatiquement la charge sur plusieurs nœuds. Les gros volumes sont traités en parallèle.",
  },
]
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            ...
            templates HTML en documents PDF prêts à imprimer. Rapide,
            fiable et d'une qualité exceptionnelle.
          </p>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-2xl border border-border/50 bg-background/50 p-8">
              <h2 className="text-xl font-semibold sm:text-2xl">Capacités</h2>
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-primary/[0.06] via-background/50 to-background/50 p-8 sm:p-12">
            ...
            <p className="mt-3 max-w-xl text-base leading-relaxed text-muted-foreground">
              Créez un compte gratuit et effectuez vos 100 premiers rendus sans frais.
