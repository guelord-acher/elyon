...
const FEATURES = [
  {
    ...
    desc: "Des milliers de documents traités simultanément. Notre répartiteur de charge distribue le travail sur l'ensemble de nos nœuds.",
  },
  {
    icon: Split,
  ...
  {
    icon: Clock,
    title: "Planification différée",
    desc: "Programmez vos traitements de masse aux heures creuses pour optimiser les coûts et les ressources.",
  },
  {
    icon: AlertTriangle,
    title: "Reprise automatique",
    desc: "En cas d'échec d'un document, le lot continue et les erreurs sont isolées. Reprise automatique sans perte de données.",
  },
]
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            Traitez des millions de documents en une seule opération. Notre moteur
            batch gère la répartition, la priorisation et la reprise automatique.
          </p>
          <div className="mt-10">
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-primary/[0.06] via-background/50 to-background/50 p-8 sm:p-12">
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Prêt à traiter en masse ?</h2>
            ...
            <Button size="lg" className="mt-6 rounded-lg normal-case text-base font-medium tracking-normal">
              Voir la documentation batch <ArrowRight className="size-4" />
            </Button>
          </div>
        </div>
      </section>
