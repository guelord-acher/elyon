...
const FEATURES = [
  {
    icon: GitBranch,
    title: "CI/CD natif",
    desc: "Actions GitHub, GitLab CI, Jenkins, CircleCI. Des pipelines prÃªts Ã  l'emploi pour intÃ©grer l'impression Ã  vos dÃ©ploiements.",
  },
  {
    icon: TestTube,
    title: "Tests de rendu",
    desc: "Validez automatiquement le rendu de vos documents Ã  chaque commit. DÃ©tectez les rÃ©gressions avant la mise en production.",
  },
  {
    icon: CheckCircle,
    title: "Validation qualitÃ©",
    desc: "Comparez les PDF gÃ©nÃ©rÃ©s avec des rÃ©fÃ©rences. VÃ©rifiez le nombre de pages, la taille, et le contenu textuel.",
  },
  {
    icon: Shield,
    title: "Validation PR",
    desc: "DÃ©clenchez une impression de test sur chaque pull request. VÃ©rifiez le rÃ©sultat avant de merger.",
  },
]
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-primary/[0.06] via-background/50 to-background/50 p-8 sm:p-12">
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">PrÃªt pour la CI/CD ?</h2>
            <p className="mt-3 max-w-xl text-base leading-relaxed text-muted-foreground">
              Ajoutez notre action GitHub en une ligne Ã  votre workflow. TestÃ© et approuvÃ© par des milliers d'Ã©quipes.
            </p>
            <Button size="lg" className="mt-6 rounded-lg normal-case text-base font-medium tracking-normal">
              Voir le guide d'intÃ©gration <ArrowRight className="size-4" />
            </Button>
          </div>
        </div>
      </section>
