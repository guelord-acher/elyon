...
const FEATURES = [
  {
    ...
    desc: "CrÃ©ez des workflows d'impression complexes avec notre Ã©diteur visuel. DÃ©clencheurs, filtres, transformations et actions en cascade.",
  },
  {
    icon: Webhook,
    title: "DÃ©clencheurs automatiques",
    desc: "Lancez des impressions depuis n'importe quel Ã©vÃ©nement : webhook entrant, commit Git, email, upload SFTP ou programmation cron.",
  },
  {
    icon: Calendar,
    title: "Planification avancÃ©e",
    desc: "Programmez vos impressions Ã  l'avance avec une syntaxe cron. IdÃ©al pour les rapports pÃ©riodiques, factures et relevÃ©s.",
  },
  {
    icon: BarChart3,
    title: "Analytics & reporting",
    desc: "Suivez vos flux d'impression en temps rÃ©el. Tableaux de bord, mÃ©triques d'utilisation et alertes personnalisables.",
  },
]
      ...
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            Automatisez vos flux d'impression de bout en bout. Plus de tÃ¢ches manuelles,
            vos documents s'impriment automatiquement selon vos rÃ¨gles.
          </p>
          <div className="mt-10">
            <Button size="lg" className="rounded-lg normal-case text-base font-medium tracking-normal">
              CrÃ©er un workflow <ArrowRight className="size-4" />
            </Button>
          </div>
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-primary/[0.06] via-background/50 to-background/50 p-8 sm:p-12">
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Passez Ã  l'automatisation</h2>
            <p className="mt-3 max-w-xl text-base leading-relaxed text-muted-foreground">
              DÃ©couvrez comment nos clients ont rÃ©duit leur charge manuelle de 85% grÃ¢ce Ã  l'automatisation.
            </p>
