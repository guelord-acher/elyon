...
const CHANNELS = [
  {
    icon: MessageCircle,
    name: "Discord",
    desc: "Rejoignez notre communaut̩ Discord. Posez vos questions, partagez vos projets et ̩changez avec l'̩quipe.",
  ...
  },
  {
    icon: MessageSquare,
    name: "Forum",
    desc: "Un forum de discussion pour les questions approfondies, les suggestions et les retours d'exp̩rience.",
    cta: "Acc̩der au forum",
    href: "#",
  },
  {
    icon: Globe,
    name: "X / Twitter",
    desc: "Suivez-nous pour les annonces, les astuces et les actualit̩s de la plateforme.",
    cta: "Nous suivre",
    href: "#",
  },
]
    ...
    <div className="min-h-svh pt-24">
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <h1 className="mt-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl max-w-3xl">Communaut̩</h1>
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            Rejoignez une communaut̩ passionn̩e de d̩veloppeurs et d'ing̩nieurs
