...
const SERVICES = [
  { name: "API d'impression", status: "Opérationnel", uptime: "99.99%" },
  { name: "Moteur de rendu", status: "Opérationnel", uptime: "99.98%" },
  { name: "SDK Registry", status: "Opérationnel", uptime: "100%" },
  { name: "CLI Updates", status: "Opérationnel", uptime: "99.95%" },
  { name: "Dashboard", status: "Opérationnel", uptime: "99.99%" },
  { name: "Webhooks", status: "Opérationnel", uptime: "99.97%" },
]
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 rounded-full border border-green-500/20 bg-green-500/10 px-3 py-1">
              ...
              <span className="text-xs font-medium text-green-500">Tous les systèmes opérationnels</span>
            </div>
          </div>
          ...
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground max-w-2xl">
            Suivez en temps réel l'état de nos services. Nous croyons en la
            transparence totale sur notre disponibilité.
          </p>
